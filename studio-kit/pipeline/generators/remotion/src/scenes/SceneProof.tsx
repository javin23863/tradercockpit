 ...
 * A QUALITY meter (held 100 + ✓, two quality marks) stays pinned — quality unchanged.
 *
 * Deliberately shares NOTHING with video #1's SceneProof (chunk-card reorder stack +
 * radial faithfulness gauge + orbiting ticks). New technique families: liquid/fill,
 * bar-race, currency particle-system, physics-ish slam with shockwave, perspective floor.
 *
 ...
 *   L5 held QUALITY meter (100 + ✓ + twin quality marks) — pinned, alive
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      <div style={{ position: 'absolute', inset: 0, transform: `translate(${shakeX}px, ${shakeY}px)` }}>
        ...
        {/* =========================================================
            L5 — QUALITY meter (held 100 + ✓ + twin quality marks)
            Pinned top-center-right region; UNCHANGED throughout.
        ========================================================= */}
        {(() => {
          const qx = 540;          // center
          const qy = 150;
        ...
        >
          <span style={{ color: subWhite }}>SAME QUALITY · </span>
          <span style={{
            background: `linear-gradient(135deg, ${accentA}, ${accentB})`,
