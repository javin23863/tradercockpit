...
CSS = """
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .lab{font:600 24px/1.3 inherit;letter-spacing:.13em;color:#7e7973;margin-bottom:18px}
...
def build_scene(sid: str, spec: dict, d: float) -> tuple[str, int]:
    ...
    for i, t in enumerate(spec.get("ticks") or []):
        add(f'  <div data-hf-id="{hid}k{i}" id="s-tk{i}" class="wrap clip" '
            f'style="top:{792 + 0}px;font:600 27px/1.4 inherit;letter-spacing:.16em;color:#6f6a65;'
