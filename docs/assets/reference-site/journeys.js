...
(() => {
  ...
  function captureGuide(kind) {
    ...
    return `${header(`Platform / ${charts?'Charts':'Models'}`,title,'A guided reading of an actual development capture—not a substitute for running the product.',crumb(charts?'Charts':'Models'))}
      ...
      <div class="j-callout"><strong>Evidence boundary</strong><p>The captured software is real. The dataset is synthetic. The preview does not establish current release approval, live connectivity or performance.</p></div>
  ...
  function unknown() {return `${header('Navigation','Page not found.','This preview does not contain the page at this address. Nothing has been submitted.')}<div class="j-recovery"><a class="button gold" href="#top">Return to homepage</a><a class="button glass" href="#/learn">Open learning library</a></div>`;}
